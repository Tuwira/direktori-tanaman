...
$pdf->Cell(40, 10, 'Tahun Ditemukan', 1, 0, 'C'); // Pindahkan Tahun Ditemukan sebelum Foto
$pdf->Cell(30, 10, 'Foto', 1, 1, 'C'); // Pindahkan Foto ke kolom terakhir
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $pdf->Cell(40, $rowHeight, $row['tahun_ditemukan'], 1, 0, 'C'); // Tahun Ditemukan ditempatkan sebelum Foto
